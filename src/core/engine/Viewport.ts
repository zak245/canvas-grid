...
export class Viewport {
    ...
    private rowHeaderWidth: number = 90;
    ...
    setDimensions(dimensions: { rowHeight?: number; headerHeight?: number; rowHeaderWidth?: number }) {
        if (dimensions.rowHeight) this.rowHeight = dimensions.rowHeight;
        if (dimensions.headerHeight) this.headerHeight = dimensions.headerHeight;
        if (dimensions.rowHeaderWidth) this.rowHeaderWidth = dimensions.rowHeaderWidth;
    }
